...
async function loginFunc(){
    ...
    if(response.status === 200){
        ...
        if(user.user_role_id === 1){
            window.location.replace("file:///C:/Users/joeid/Revature/ProjectOneRepo/ers/FrontEnd.Manager.html")
        } else if(user.user_role_id === 2){
            window.location.replace("file:///C:/Users/joeid/Revature/ProjectOneRepo/ers/FrontEnd.Employee.html")
        }
